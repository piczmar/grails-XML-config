...
public class TokenServices extends org.springframework.security.oauth2.provider.token.DefaultTokenServices {

    private static Logger logger = Logger.getLogger(TokenServices.class);
