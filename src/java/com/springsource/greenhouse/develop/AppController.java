...
public class AppController {
	...
	public List<AppSummary> list(User account) {
	...
	public String create(@Valid AppForm form, BindingResult bindingResult, User account) {
	...
	public String view(@PathVariable String slug, User account, Model model) {
	...
	public String delete(@PathVariable String slug, User account) {
	...
	public String editForm(@PathVariable String slug, User account, Model model) {
	...
	public String update(@PathVariable String slug, @Valid AppForm form, BindingResult bindingResult, User account, Model model) {
		if (bindingResult.hasErrors()) {
			model.addAttribute("slug", slug);			
			return "develop/apps/edit";
		}
