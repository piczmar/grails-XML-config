			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="text" title="${message(code: 'demo.text.label', default: 'Text')}" />
				...
				<g:each in="${demoInstanceList}" status="i" var="demoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${demoInstance.id}">${fieldValue(bean: demoInstance, field: "text")}</g:link></td>
